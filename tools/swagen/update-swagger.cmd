@ECHO OFF
     ...
     SET SwaggerUrl=%1
     IF "%SwaggerUrl%"=="" (
         SET SwaggerUrl=http://localhost:53582/swagger/docs/v1
     )
     IF "%SwaggerUrl%"=="""" (
         SET SwaggerUrl=http://localhost:53582/swagger/docs/v1
     )
     ...
     .\tools\swagen\swagen.exe %SwaggerUrl% -out:%OutputFile% -modelns:sierra.model -servicens:sierra.service -ref:../../../../typings/tsd.d.ts -ref:../../../../typings/app.d.ts
